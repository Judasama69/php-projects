            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                        ...
                        <a href="/laracast/project"
                            class="<?php echo urlIs('/laracast/project') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white'; ?> rounded-md px-3 py-2 text-sm font-medium">Projects</a>
                        <a href="/laracast/contact"
                            class="<?php echo urlIs('/laracast/contact') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white'; ?> rounded-md px-3 py-2 text-sm font-medium">Contacts</a>
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <el-dropdown class="relative ml-3">
                        <button
                            ...
                            <img src="/laracast/assets/kenjie.jpg" alt=""
                                class="size-14 rounded-full outline -outline-offset-1 outline-white/10" />
                        </button>
